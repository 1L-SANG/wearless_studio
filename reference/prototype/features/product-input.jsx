/* =============================================================
   features/product-input.jsx — ① 제품 정보 입력 (PRD §5)
   확정 레이아웃: 각도 2×2 wells(기본 색상) + 색상별 타일(추가 색상).
   ============================================================= */
...
function ProductInput({ onPhase, onNext }) {
...
window.ProductInput = ProductInput;
