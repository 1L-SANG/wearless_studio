/* =============================================================
   features/analysis.jsx — ② AI 분석·세부 확인 (PRD §6)
   Now also hosts 의류 종류 + 실측 정보 (moved from the input page).
   Used two ways:
     - inline (below the input page, after 입력 완료) → AnalysisForm inline
     - standalone (시안 비교 canvas) → Analysis with its own loading
   AnalysisSkeleton = the shimmer placeholder shown while analyzing.
   ============================================================= */
...
function AnalysisForm({ inline, analysis, catalogs, onChange, onNext }) {
  const a = analysis;
...
Object.assign(window, { Analysis, AnalysisForm, AnalysisSkeleton });
