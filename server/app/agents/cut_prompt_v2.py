...
_MANIFEST_ROLES = (
    ...
    ("PRODUCT — detail close-up", "PRODUCT_DETAIL", "sold garment material, stitching, print and hardware evidence"),
    ("PRODUCT — fit reference", "PRODUCT_FIT", "sold garment true length, fit and drape evidence"),
