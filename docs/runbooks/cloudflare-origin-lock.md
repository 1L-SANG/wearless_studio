...
- 원본 응답 대기 **100초**(무료/Pro). 14일 최대 TargetResponseTime 45초(2026-09-13)라 여유는 있다.
  공개 분석은 provider 상한 30초 + 폴백 30초.
- 요청 본문 **100MB**. 앱 상한은 업로드 25MB · 공개 분석 60MB · 신분증 12MB.
