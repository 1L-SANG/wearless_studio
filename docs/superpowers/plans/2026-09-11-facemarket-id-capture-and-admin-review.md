...
| 파일 | 책임 |
| --- | --- |
| `supabase/migrations/20260911120000_facemarket_id_capture_review.sql` | 상태 enum 확장, 인증수단·신분증·심사 컬럼 추가, partial unique index 재생성 |
...
**Files:**
- Create: `supabase/migrations/20260911120000_facemarket_id_capture_review.sql`
...
git add supabase/migrations/20260911120000_facemarket_id_capture_review.sql server/tests/test_facemarket_id_capture_migration.py
