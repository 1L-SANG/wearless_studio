...
현행 구독은 Starter 600cr(29,900원), Seller 1,600cr(69,900원), Pro 2,800cr(119,000원)이다. 충전은 100cr(5,500원, 크레딧당 55원)과 500cr(26,000원, 크레딧당 52원) 두 종류다(2026-09-24 오너 결정, 마이그레이션 `20260924200000_topup_packs_100_500.sql`). 예전 5종(마무리·시작·반복·시즌·대량)은 판매만 껐고 기록 연결 때문에 행은 남아 있다. 기존 비활성 legacy 상품과 잔액은 보존한다.
