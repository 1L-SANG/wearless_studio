...
- BFS 강도 스윕: **1.2 가 최적**(코·입술·볼이 더 가까워짐, 닮음 0.333→0.41). 1.4 는 머리가 부풀며 멀어짐(0.25).
...
4. ComfyUI: Qwen-Image-Edit-2511 + BFS Head V5 + LanPaint(20 step, cfg 2.5, 강도 1.2), 그림1 = 크롭,
   그림2 = 등록자 각도 사진.
