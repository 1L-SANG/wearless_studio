...
- 현재 등록은 본인확인, 사진, 조건, 증서의 네 단계이며 사진은 18장이다. 그늘 9장과 나머지 조명에서 3장씩 9장을 받는다. 내부 학습용 12장, 기준 3장, 공개 자산용 측면 1장, 추가 각도 2장으로 쓰임새를 구분한다. 등록 후 검수와 테스트컷 제작을 거쳐 본인이 확정한 뒤 공개한다. 구형 사진 슬롯 호환은 유지하며, 신규 안내는 [등록 흐름 정본](facemarket_registration_flow.md)을 따른다.
