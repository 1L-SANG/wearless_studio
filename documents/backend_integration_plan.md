...
> **과금 구현 상태(2026-09-11):** 기존 예약·확정 경로에 v6 행동별 단가(마네킹 45cr, AI 컷 19cr, 편집 19cr)를 배선했다. 1cr=50원이며 서버 설정과 프론트 미러가 일치한다. 플랜별 할인·무료 수정과 라이선스 크레딧 결제 등 남은 범위는 PRD §12.2를 따른다. 환불 정책과 PG 운영은 해당 계약·런북에서 관리한다.
