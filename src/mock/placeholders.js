/* =============================================================
   mock/placeholders.js — monochrome SVG placeholder "photos".
   (ported from handoff prototype; window.* → ES module)
   The design system forbids stock photography; these grayscale
   tiles stand in for fashion cuts and stay on-brand. Deterministic
   by seed so the same asset id always renders the same tile.
   ============================================================= */
