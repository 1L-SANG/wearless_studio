...
const FAQ = [
  { q: 'AI 생성 방식의 초상 활용이란 실제로 무엇을 뜻하나요?', a: '브랜드가 촬영 없이 당신의 얼굴로 상품 착용컷·캠페인 이미지를 생성해요. 어떤 품목에 얼마 동안 쓸 수 있는지는 당신이 라이선스 조건으로 직접 정하고, 가격은 플랫폼 표준가를 따라요. 그 조건 밖의 사용은 막혀요.' },
  { q: '초상 라이선싱이란 무엇인가요?', a: '당신의 얼굴을 쓰는 조건(용도·기간)을 정해 두고, 브랜드가 그 조건 안에서만 쓰게 하는 계약이에요. 조건은 누구나 확인할 수 있는 라이선스로 남고, 언제든 철회할 수 있어요.' },
  ...
  { q: '보상은 어떻게 이루어지나요?', a: '상업적 사용이 발생할 때마다 플랫폼 표준가를 기준으로 정산돼요. 대가 없는 사용은 없어요.' },
