...
export function renderConsent(consents, setConsents, withdrawalOpen, setWithdrawalOpen) {
  ...
  return <>
    ...
    <div className={s.consentList}>
      ...
      <div className={s.consentCard}><span className={s.tag}>안내 · 동의 아님</span><p className={s.consentLabel}><span>얼굴 정보는 착용컷을 만들기 위해 미국의 서버와 저장소, 이미지 생성 서비스로 전송돼요. 계약 이행을 위한 위탁이라 동의 대신 알려 드려요(개인정보 보호법 제28조의8 제1항 제3호).</span></p><div className={s.legalSummary}>
