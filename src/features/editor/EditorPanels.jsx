...
/* ---------- AI ---------- */
export function AIPanel({ catalogs, account, colorOpts = [], detailColorOpts = [], clothingType = 'top', hasDetailImage = false, varySource, onGenerate, onVaryGenerate, onPickRef, onPickMoodRef, onSetCutType }) {
