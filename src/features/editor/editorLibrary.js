...
export const DETAIL_PAGE_TEMPLATE = [
  kiwiTemplate({
    id: 'dp-01-hero', label: '01 Hero', h: 1100, bg: '#d9d9da', elements: [
      ...
      templatePhoto(-17, 359, 98, 520, { radius: 20 }),
      templatePhoto(94, 359, 804, 520, { radius: 20 }),
      templatePhoto(912, 359, 97, 520, { radius: 20 }),
  ...
  kiwiTemplate({
    id: 'dp-02-detailcheck', label: '02 Detail Check', h: 1100, bg: '#e9e9eb', elements: [
      ...
      templatePhoto(58, 269, 337, 220, { radius: 16 }),
      ...
      templatePhoto(605, 513, 337, 220, { radius: 16 }),
      templateShape(58, 757, 884, 220, '#fafafa', { radius: 16 }),
      templatePhoto(58, 757, 337, 220, { radius: 16 }),
  ...
  kiwiTemplate({
    id: 'dp-03-detailcheck-d', label: '03 Detail Check :D', h: 1100, bg: '#e4e4e4', elements: [
      ...
      templatePhoto(98, 730, 395, 330, { radius: 10 }),
      templatePhoto(507, 730, 395, 330, { radius: 10 }),
    ],
  }),
  kiwiTemplate({
    id: 'dp-04-point-02-03', label: '04 Point 02-03', h: 1100, bg: '#e4e4e4', elements: [
      ...
      templatePhoto(85, 212, 830, 330, { radius: 10 }),
      ...
      templatePhoto(85, 713, 408, 290, { radius: 10 }),
      templatePhoto(507, 713, 408, 290, { radius: 10 }),
    ],
  }),
  kiwiTemplate({
    id: 'dp-05-material', label: '05 Material', h: 1100, bg: '#ededef', elements: [
      templatePhoto(0, 0, 1000, 700),
      templateShape(714, 350, 210, 206, '#ffffff', { radius: 12 }),
      templatePhoto(720, 356, 198, 154, { radius: 9 }),
  ...
  kiwiTemplate({
    id: 'dp-07-color-list', label: '07 Color List', h: 1100, bg: '#ededef', elements: [
      templatePhoto(0, 0, 332, 620), templatePhoto(334, 0, 332, 620), templatePhoto(668, 0, 332, 620),
  ...
  kiwiTemplate({
    id: 'dp-08-color-detail', label: '08 Color Detail', h: 1100, bg: '#e9e9eb', elements: [
      templatePhoto(0, 0, 322, 570), templatePhoto(324, 0, 322, 570), templatePhoto(648, 0, 352, 570),
  ...
  kiwiTemplate({
    id: 'dp-09-cap', label: '09 Cap', h: 1100, bg: '#e9e9eb', elements: [
      ...
      templatePhoto(490, 300, 470, 400, { radius: 10 }),
  ...
  kiwiTemplate({
    id: 'dp-10-look-1', label: '10 Look 1', h: 1100, bg: '#e9e9eb', elements: [
      ...
      templatePhoto(58, 286, 649, 632, { radius: 12 }),
      templatePhoto(726, 286, 216, 200, { radius: 12 }),
      templatePhoto(726, 502, 216, 200, { radius: 12 }),
      templatePhoto(726, 718, 216, 200, { radius: 12 }),
  ...
  kiwiTemplate({
    id: 'dp-12-sale-row', label: '12 Sale Row', h: 1100, bg: '#e4e4e2', elements: [
      ...
      templatePhoto(82, 328, 250, 250, { radius: 10 }),
      ...
      templatePhoto(82, 650, 250, 250, { radius: 10 }),
  ...
  kiwiTemplate({
    id: 'dp-13-sale-grid', label: '13 Sale Grid', h: 1100, bg: '#e4e4e2', elements: [
      ...
      templatePhoto(74, 324, 396, 420, { radius: 4 }),
      ...
      templatePhoto(530, 324, 396, 420, { radius: 4 }),
...
export const DETAIL_PAGE_TEMPLATE_2 = [
  ...
  kiwiTemplate({
    id: 't2-02-summermood', label: 'T2 SUMMER MOOD', h: 1304, bg: '#efefef', elements: [
      templatePhoto(584, 0, 416, 373, { stroke: '#000000', strokeWidth: 2 }),
      templatePhoto(584, 392, 416, 374, { stroke: '#000000', strokeWidth: 2 }),
      ...
      templatePhoto(0, 784, 1000, 520, { stroke: '#000000', strokeWidth: 2 }),
  ...
  kiwiTemplate({
    id: 't2-03-look01', label: 'T3 LOOK 01', h: 1310, bg: '#efefef', elements: [
      ...
      templatePhoto(178, 66, 492, 701, { stroke: '#111111', strokeWidth: 2 }),
      templatePhoto(573, 393, 400, 748, { stroke: '#111111', strokeWidth: 2 }),
      templatePhoto(49, 815, 481, 449, { stroke: '#111111', strokeWidth: 2 }),
  ...
  kiwiTemplate({
    id: 't2-04-detailcheck', label: 'T4 DETAIL CHECK', h: 1317, bg: '#efefef', elements: [
      ...
      templatePhoto(0, 209, 497, 367, { stroke: '#000000', strokeWidth: 2 }),
      ...
      templatePhoto(498, 577, 502, 367, { stroke: '#000000', strokeWidth: 2 }),
...
export const DETAIL_PAGE_TEMPLATE_3 = [
  ...
  kiwiTemplate({
    id: 't3-01-photolayout', label: 'U01 PHOTO LAYOUT', h: 1283, bg: '#9a9a9c', elements: [
      templatePhoto(0, 0, 1000, 697),
      templatePhoto(0, 697, 1000, 586),
  ...
  kiwiTemplate({
    id: 't3-02-bestitem', label: 'U02 BEST ITEM', h: 1260, bg: '#5c5c5b', elements: [
      ...
      templatePhoto(345, 193, 610, 1061),
      templatePhoto(55, 365, 406, 548),
  ...
  kiwiTemplate({
    id: 't3-03-detailcut', label: 'U03 DETAIL CUT', h: 1252, bg: '#f7f6f3', elements: [
      ...
      templatePhoto(17, 417, 260, 656, { rotate: -3, stroke: '#ffffff', strokeWidth: 11 }),
      templatePhoto(740, 431, 243, 656, { rotate: 3, stroke: '#ffffff', strokeWidth: 11 }),
      templateShape(241, 372, 531, 698, '#ffffff'),
      templatePhoto(264, 395, 485, 652),
  ...
  kiwiTemplate({
    id: 't3-04-roundknit', label: 'U04 ROUND KNIT', h: 1278, bg: '#a7b8c3', elements: [
      ...
      templatePhoto(52, 416, 435, 578),
      templatePhoto(513, 182, 435, 485),
      templatePhoto(513, 696, 435, 582),
  ...
  kiwiTemplate({
    id: 't3-05-gridtext', label: 'U05 GRID TEXT', h: 1266, bg: '#a7b8c3', elements: [
      ...
      templatePhoto(43, 684, 416, 544, { rotate: -3, stroke: '#ffffff', strokeWidth: 14 }),
      templatePhoto(502, 638, 499, 628),
    ],
  }),
  ...
  kiwiTemplate({
    id: 't3-07-daily', label: 'U07 DAILY', h: 1277, bg: '#f2f2f0', elements: [
      templatePhoto(88, 91, 412, 547),
      templatePhoto(500, 91, 412, 547),
      templatePhoto(88, 638, 412, 547),
      templatePhoto(500, 638, 412, 547),
  ...
  kiwiTemplate({
    id: 't3-08-productdetail', label: 'U08 PRODUCT DETAIL', h: 1278, bg: '#f7f6f3', elements: [
      ...
      templatePhoto(52, 285, 896, 443),
      templatePhoto(55, 756, 285, 474),
      templatePhoto(353, 756, 355, 474),
      templatePhoto(721, 756, 279, 474),
  ...
  kiwiTemplate({
    id: 't3-09-sideback', label: 'U09 SIDE/BACK', h: 1281, bg: '#bebfbc', elements: [
      ...
      templatePhoto(532, 190, 391, 448, { stroke: '#3a3a3a', strokeWidth: 2 }),
      templateText(547, 205, 300, 40, 'Side', { font: 'Cormorant', size: 30, color: '#2e2e2e' }),
      templatePhoto(532, 655, 391, 479, { stroke: '#3a3a3a', strokeWidth: 2 }),
  ...
  kiwiTemplate({
    id: 't3-10-ivory', label: 'U10 IVORY KNIT', h: 1282, bg: '#a7b8c3', elements: [
      ...
      templatePhoto(49, 228, 587, 767),
      templateText(67, 953, 550, 24, '일부 이미지는 AI로 생성되었습니다.', { size: 15, color: '#ededed' }),
      templatePhoto(655, 172, 262, 366),
      templateText(587, 358, 80, 60, '→', { size: 47, color: '#2e2e2e' }),
      templatePhoto(572, 716, 373, 482, { stroke: '#ffffff', strokeWidth: 14 }),
...
export const DETAIL_PAGE_TEMPLATE_4 = [
  ...
  kiwiTemplate({
    id: 't4-01-mdpick', label: 'V01 MD PICK', h: 1277, bg: '#e4e4e0', elements: [
      ...
      templatePhoto(188, 319, 625, 711, { radiusTopRight: 300 }), // 아치(통합 시 per-corner 지원)
  ...
  kiwiTemplate({
    id: 't4-07-review', label: 'V07 REVIEW', h: 1275, bg: '#c3c2be', elements: [
      ...
      templateShape(42, 175, 916, 313, '#f8f8f5'), templatePhoto(57, 190, 348, 283),
      ...
      templateShape(42, 503, 916, 313, '#f8f8f5'), templatePhoto(57, 518, 348, 283),
      ...
      templateShape(42, 835, 916, 313, '#f8f8f5'), templatePhoto(57, 850, 348, 283),
  ...
  kiwiTemplate({
    id: 't4-11-modelsize', label: 'V11 MODEL SIZE', h: 1250, bg: '#c3c2be', elements: [
      ...
      templatePhoto(207, 217, 582, 582, { radius: 291 }),
...
export const DETAIL_PAGE_TEMPLATE_5 = [
  ...
  kiwiTemplate({
    id: 't5-03-whypants', label: 'W03 WHY PANTS', h: 1280, bg: '#616160', elements: [
      templatePhoto(0, 0, 1000, 1280),
      ...Array.from({ length: 19 }, (_, i) => templateShape(44 + 48 * i, 51, 37, 3, '#ffffff')),
      templatePhoto(52, 97, 81, 81, { radius: 40, stroke: '#ffffff' }),
  ...
  kiwiTemplate({
    id: 't5-05-detail', label: 'W05 PRODUCT DETAIL', h: 1282, bg: '#f7f6f3', elements: [
      ...
      templatePhoto(310, 383, 319, 812),
      templatePhoto(104, 452, 252, 252, { radius: 126 }),
      ...
      templatePhoto(638, 855, 261, 261, { radius: 130 }),
  ...
  kiwiTemplate({
    id: 't5-07-denim', label: 'W07 SUMMER DENIM', h: 1275, bg: '#3a3a39', elements: [
      ...
      templatePhoto(337, 613, 483, 483, { radius: 242 }),
  ...
  kiwiTemplate({
    id: 't5-08-detailcut', label: 'W08 DETAIL CUT', h: 1281, bg: '#bebfbc', elements: [
      ...
      templatePhoto(527, 187, 403, 443, { stroke: '#4a4a48' }),
      templateText(545, 205, 300, 50, 'Side', { font: 'Cormorant', size: 35, color: '#2e2e2d' }),
      templatePhoto(527, 657, 403, 438, { stroke: '#4a4a48' }),
  ...
  kiwiTemplate({
    id: 't5-09-dailyseries', label: 'W09 DAILY SERIES', h: 1281, bg: '#f7f6f3', elements: [
      ...
      templatePhoto(50, 252, 448, 552), templatePhoto(499, 252, 449, 552),
